...
public enum Scales {
    ONE_TO_20(20f, 0.5f,ObjectScales.CHAIR),
    ONE_TO_25(25f, 0.5f,ObjectScales.CHAIR),
    ...
    ONE_TO_125(125f, 1.0f,ObjectScales.HUMAN_SCALE),
    ONE_TO_200(200f, 5.0f,ObjectScales.HOUSE),
    ONE_TO_250(250f, 5.0f,ObjectScales.HOUSE),
